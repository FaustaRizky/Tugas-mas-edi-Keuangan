...
<head>
	...
	<title>Financial - Pemasukkan</title>
	...
	<style>
		...
		.table {
			width: 100%;
			min-width: 100%; /* Ensure it spans the entire container */
			max-width: 100%;
		}
	</style>
</head>
	...
	<div class="main-content khusus">
		<div class="konten khusus2">
			<div class="konten_dalem khusus3">
				<h4 class="head">Tambah Data Pemasukkan</h4>
				...
				<!-- bagian isi tabel -->
				<div class="headline">
					<h5 style="background-color: #B3B5FF; color: black; font-weight: 500; margin-left: 0px; padding-left: 4%;">Data Pemasukkan</h5>
				</div>
				<div id="container">
				...
				<div class="table-responsive">
					<table class="table table-sm table-hover table-striped table-bordered">
						<tr>
							...
							<th class="header-color">Jumlah Pemasukkan</th>
