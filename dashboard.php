                    ...
                    <div class="row tampilCardview" style="justify-content:center ;" id="row">
                        ...
                        <div class="col-md-5 jarak">
                            <a href="tambahPemasukkan" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #5DB85B; border-radius: 15px;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                        ...
                        <div class="col-md-5 jarak">
                            <a href="tambahPengeluaran" style="text-decoration: none;">
                                <div class="card card-stats" style="background: #F05454; border-radius: 15px;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                ...
                                <div class="overlay" style="background: #e45351; border-radius: 15px;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                        ...
                        <div class="rekening">
                            <div class="row tampil">
                                ...
                                <div class="col-lg rek ">
                                    <canvas id="myChart" width="60px" height="24px"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Jumlah (Rp)',
                    data: [<?php echo $totalMasuk; ?>, <?php echo $totalKeluar; ?> ],
                    backgroundColor: [
                        '#70c745', // Warna hijau untuk pemasukan
                        '#E72929' // Warna merah untuk pengeluaran
                    ],
                    borderColor: [
                        '#70c745', // Warna hijau untuk pemasukan
                        '#E72929' // Warna merah untuk pengeluaran
