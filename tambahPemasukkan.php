        ...
        <div class="konten">
            <div class="konten_dalem">
                ...
                <div class="headline" style="background-color: #B3B5FF;">
                    <h5 style="color: black;">Tambah Data Pemasukkan</h5>
                </div>
                    ...
                    <div class="konten_isi">
                        <form class="form-text" action="" method="post">
                            <table class="table" style="width: 100%;">
                                <tr>
                                    <td class="label-column" style="width: 30%; line-height: 1.2;">Tanggal Pemasukkan</td>
                                    <td style="width: 5%;">:</td>
                                    <td style="width: 65%;"><input class="form-control" type="date" value="<?= $today ?>" name="tanggal" required></td>
                                </tr>
                                <tr>
                                    <td class="label-column" style="width: 30%; line-height: 1.2;">Keterangan Pemasukkan</td>
                                    <td style="width: 5%;">:</td>
                                    <td style="width: 65%;"><input class="form-control wide-input" type="text" name="keterangan" autocomplete="off" required></td>
                                </tr>
                                <tr>
                                    <td class="label-column" style="width: 30%; line-height: 1.2;">Sumber Pemasukkan</td>
                                    <td style="width: 5%;">:</td>
                                    <td style="width: 65%;">
                                ...
                                <tr>
                                    <td class="label-column" style="width: 30%; line-height: 1.2;">Jumlah Pemasukkan</td>
                                    <td style="width: 5%;">:</td>
